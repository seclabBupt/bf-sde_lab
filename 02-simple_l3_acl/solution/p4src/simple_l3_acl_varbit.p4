...
/* PCP(Priority Control Point): When the switch/router is congested, high-priority data frames are sent first.
   CFI(Canonical Format Indicator): indicate whether the MAC address is typical format.
   VID(VLAN ID):     */
header vlan_tag_h {
    bit<3>        pcp;
    bit<1>        cfi;
